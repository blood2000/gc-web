                    ...
                    _createClass(FlowController, [{
                        ...
                        value: function onMediaAttached(data) {
                            ...
                            if (data.websocketName != undefined) {
                                ...
                                this.wfs.attachWebsocket(client, data.channelName, data.mediaType);
                            } else {
                ...
                var WebsocketLoader = function (_EventHandler) {
                    ...
                    _createClass(WebsocketLoader, [{
                        ...
                        value: function initSocketClient(client) {
                            ...
                            this.wfs.trigger(_events2.default.WEBSOCKET_MESSAGE_SENDING, { commandType: this.mediaType, channelName: this.channelName });
                        ...
                        value: function receiveSocketMessage(event) {
                            ...
                            if (this.buf.length === 640) {
                                if (this.wfs.switchStream) {
                                    var sine = new Uint8Array(this.buf);
                                    this.wfs.player.feed(sine);
                                    //playerArr[$(this.wfs.media).parent().attr('data-myplayer')].feed(sine);
                                }
                            } else {
                        ...
                        value: function onWebsocketMessageSending(event) {
                            ...
                            console.log('event.channelName', event.channelName)
                            console.log('userInfo', UserInfoGlobal)
                            var MSGID = UserInfoGlobal.MSGID
                            var userId = UserInfoGlobal.userId
                            this.client.send(JSON.stringify({ HEAD: { MSGID: MSGID, USERID: userId, TRANSNO: 0 }, PARAM: event.channelName }));
                            //wfsObjArr = [];
                        }
                    }]);
                ...
                var Wfs = function () {
                    ...
                    _createClass(Wfs, [{
                        ...
                        value: function attachMedia(media) {
                            ...
                            var websocketIP = "219.134.190.133:6003"; //媒体服务ip
                            var websocketName = websocketIP;
                            var player = arguments[1][1];
                            var userInfo = arguments[1][2]
                        ...
                        value: function attachWebsocket(websocket, channelName) {
                            console.log('attachWebsocket userinfo ', this.userInfo)
