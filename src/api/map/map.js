...
export default {
  ...
  getVehicleLoLocations:'/fmsweb/vehicle/device/v2/locations', // 获取车辆定位列表
  getDeviceLocationInfo:(plateNumber)=>`/fmsweb/vehicle/device/v2/location/${plateNumber}`, // 获取设备定位信息
  getVehicleInfo:(vehicleCode,type)=>`/fmsweb/vehicle/device/v2/detail/${vehicleCode}/${type}`, // 获取车辆信息接口
  ...
  getVehicleTrack:'/fmsweb/vehicle/device/v2/track', // 查询车辆历史轨迹
  getVehicleEventTrack:'/fmsweb/vehicle/event/v2/list', // 查询事件轨迹
  appinfo:'/fmsweb/basic/common/v1/sysParam',//应用信息
